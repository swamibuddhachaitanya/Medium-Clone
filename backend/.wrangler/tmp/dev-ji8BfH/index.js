...
// .wrangler/tmp/bundle-2tEOtT/checked-fetch.js
...
// .wrangler/tmp/bundle-2tEOtT/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();

// .wrangler/tmp/bundle-2tEOtT/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();
...
blogRouter.use("/*", async (c, next) => {
  ...
  try {
    const user = await (0, import_jsonwebtoken.verify)(authHeader, c.env.JWT_SECRET);
    if (user) {
